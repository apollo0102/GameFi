const CardMain = () => {
  return (
    <div className='w-full flex flex-col justify-start'>
      <div className='bg-[#C4C4C4]/[.05] pt-[50px] pl-[50px] pb-4 mb-5'>
        <ul>
          <li className='text-[24px] font-bold text-white mb-5 w-[150px] sm:w-auto'>
            Connected MetaMask
          </li>
          <li className='font-normal text-white/[.5] mb-[35px] w-[150px] sm:w-[250px]'>
      ...
      <div className='bg-[#C4C4C4]/[.05] pt-[50px] pl-[50px] pb-4 mb-5'>
        <ul>
          ...
          <li className='font-normal text-white/[.5] mb-3 w-[150px] sm:w-[250px]'>
